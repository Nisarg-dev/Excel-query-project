...
export default function App(): React.ReactNode {
  ...
  const [autoLoadedFile, setAutoLoadedFile] = useState<boolean>(false);  // Check for existing data on app load
  useEffect(() => {
    ...
    <div className="min-h-screen bg-gray-900 text-gray-200 font-sans">
      <main className="container mx-auto p-4 md:p-8">
        <header className="text-center mb-8 pb-4">
          <h1 className="text-4xl md:text-5xl font-bold text-blue-400 leading-tight px-4">
            Indian Agrochemical Registration Committee Updates
          </h1>
